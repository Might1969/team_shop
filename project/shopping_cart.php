...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="flex">
         <p class="price"><span class="styled-dollar">&dollar;</span> <?= $fetch_cart['price']; ?></p>
      ...
      <p class="sub-total">sub total : <span class="styled-dollar">&dollar; <?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span></p>
   ...
   <?php if($grand_total != 0){ ?>
      <div class="cart-total">
         <p>grand total : <span class="styled-dollar">&dollar; <?= $grand_total; ?></span></p>
